    ...
    <nav className="fixed top-0 left-0 right-0 bg-[#0a0a0a]/90 backdrop-blur-md z-50 border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link to="/" className="flex items-center gap-2 bg-[#1a1a1a] rounded-xl px-3 py-1.5 border border-white/10">
            <img src="/logo-seen.png" alt="Seen Barbershop" className="h-9 w-auto object-contain" />
          </Link>
